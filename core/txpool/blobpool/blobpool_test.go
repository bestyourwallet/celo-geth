...
func benchmarkPoolPending(b *testing.B, datacap uint64) {
	...
	pool.txValidationFn = func(tx *types.Transaction, head *types.Header, signer types.Signer, opts *txpool.CeloValidationOptions, fcc common.FeeCurrencyContext) error {
