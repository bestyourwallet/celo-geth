...
func TestFilterAllowlisted(t *testing.T) {
	...
	toBeRemoved := txC(8, 2, 1, 15000, &curr2)
	list.Add(toBeRemoved, DefaultConfig.PriceBump, rates)
	list.Add(txC(9, 1, 1, 10000, &curr1), DefaultConfig.PriceBump, rates)
	assert.Equal(t, uint64(30000), list.TotalCostFor(&curr2).Uint64())
...
func TestFilterAllowlistedStrict(t *testing.T) {
	...
	list.Add(toBeInvalid, DefaultConfig.PriceBump, rates)
...
func TestFilterBalance(t *testing.T) {
	...
	list.Add(toBeRemoved, DefaultConfig.PriceBump, rates)
	list.Add(txC(9, 1, 1, 10000, &curr3), DefaultConfig.PriceBump, rates)
