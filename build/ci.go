...
import (
	...
	"github.com/bestyourwallet/celo-geth/crypto/signify"
	"github.com/bestyourwallet/celo-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/bestyourwallet/celo-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/bestyourwallet/celo-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/bestyourwallet/celo-geth/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/bestyourwallet/celo-geth/core/rawdb", "github.com/bestyourwallet/celo-geth/ethdb/leveldb"},
		{"github.com/bestyourwallet/celo-geth/core/rawdb", "github.com/bestyourwallet/celo-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
